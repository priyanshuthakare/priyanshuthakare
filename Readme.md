...
- 🤖 **AI/ML Tools** — Building practical AI-powered apps with Python, LangChain, and modern LLM APIs
- 🌍 **Open Source** — Contributing to projects I use and love; check my pinned repos below!
- ⚡ **Scalable Backends** — Clean APIs, smart caching, and systems that don't fall over
- 🎨 **Creative Web Experiences** — When the frontend deserves to be as interesting as the backend
